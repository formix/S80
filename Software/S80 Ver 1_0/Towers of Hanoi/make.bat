...
zcc +z80 -clib=sdcc_iy -create-app --c-code-in-asm --list -m -startup=1 -Cz"--rombase=0x2000 --romsize=0x0A00 --ihex" -pragma-define:CRT_ORG_CODE=0x2000 -o S80_towers_of_hanoi S80_towers_of_hanoi.c S80_reboot.asm S80_serial.asm
